...
/* AUTHOR INFORMATION
 * CREATOR - Jeremy Dunnet 05/03/2019
 * LAST MODIFIED BY - Jeremy Dunnet 05/03/2019
 */

/* CLASS/FILE DESCRIPTION
 * This is the integration test for Medical Data Input Stream - testing all created functionality works with XML and State Calculator classes
 */

/* VERSION HISTORY
 * 05/03/2019 - Created file and completed testing
 */
...
public class StreamTwoTest {
    ...
    public void mSuccess() {
        ...
        //Need to manually check file on device to make sure write successful and state calc recorded
