...
public class Create_File implements File_Management {
     ...
     * This Method can only handle the task values 'New_Account', 'Create_Account_File', 'Create_Medical_File',
     * 'Create_Review_File', and 'Create_Login_File'
     *
     * @param file         Represents the File directory object to add files to
     * @param task         Defines what task should be carried out
     * @param account_Name Name of the New Account to create a directory. If not used must be set to a non null values
     ...
     */
    @Override
    public Boolean Manage_File(File file, File_Task task, String account_Name) throws Invalid_Task_Exception, Parameter_Exception, NullPointerException, File_Exception {
        if (file == null) {
            ...
            switch (task) {
                ...
                case Create_Medical_File:
                    ...
                    break;
                case New_Account:
                    CreateAccountDirectory(file, account_Name);
                    break;
    ...
    /**
     * This private method functionality is to create a new account directory, within the file directory provided, on
     * the devices internal storage. If
     ...
     * @param account_Name The value to name the new directory
     * @throws File_Exception if the directory creation fails in any way, or adding of files within it failed once the
     *                        directory has been created
     */
    private void CreateAccountDirectory(File file, String account_Name) throws File_Exception {
        String path = file.getPath();
        path += FILE_SEPARATOR + account_Name;
    ...
    /**
     * This private method functionality is to create a Review File, within the account file directory provided, on the
    ...
    /**
     * This private method functionality is to create a Account File, within the account file directory provided, on the
     * devices internal storage.
     *
     * @param file Represents the file to add the new account directory to
     * @throws File_Exception if the creating of the file fails in any way
    ...
    /**
     * This private method functionality is to create a Medical File, within the account file directory provided, on the
     * devices internal storage.
     *
     * @param file Represents the file to add the new account directory to
     * @throws File_Exception if the creating of the file fails in any way
    ...
    /**
     * This private method functionality is to create a Login File, within the directory provided for the application,
     * on the devices internal storage.
     * <h1>Note</h1>
     * This method should be called at the start of the launch of the program as it is required for people to be able to
