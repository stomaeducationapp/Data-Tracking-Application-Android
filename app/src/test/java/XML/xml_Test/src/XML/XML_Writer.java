 ...
 * <h>Note</h>
 * When Using the Medical Writer, The Enum value "Number_Of_Entries_To_Write"
 * needs to be given, even when only 1. The entries need to be appended with the
 * number value. e.g 2nd entry will have all keys appended with '2'. This allows
 * differentiation between them. The order of entries will be X -> 1 in the XML
 * file, where X is the highest entry.
 *
...
public interface XML_Writer {
    ...
    public enum Tags_To_Write {
        ...
        Modify, New, Export, Create, Delete
